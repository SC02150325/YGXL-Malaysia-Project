...
> 4天3晚 · 2026/10/15 - 2026/10/18 · 4人（2男生 L/Y · 2女生 G/X）
>
> 广州 → 吉隆坡 → 马六甲 → 吉隆坡机场 → 广州



## 出发必看 / Before Departure

- [ ] 身份证：确认已随身携带，用于国内出发、值机或必要身份核验。
- [ ] 护照：确认原件在有效期内，并随身携带；不要只依赖电子照片或复印件。
- [ ] 航班：确认去程 AirAsia AK113 和返程 AirAsia AK116 的日期、机场、航站楼、时间及个人值机信息。
- [ ] 电子入境卡：每位旅客独立完成 Malaysia Digital Arrival Card（MDAC），并确认提交信息无误。
- [ ] 手机卡：确认国内号码可接收短信，提前准备马来西亚 SIM 卡或 eSIM，并确认激活方式。
- [ ] 充电设备：准备手机充电器、充电线和充电宝；充电宝随身携带，不放入托运行李。
- [查看详细清单 / Open Full Checklist](./checklist/)
...
下午抵达 KUL T2，完成入境、取行李并与 Trip.com 接机司机会合（15:30 接机已确认），前往 Eaton Residence KLCC。接机时间为 15:30，司机在到达出口举牌等候。入住后安排泳池休息、观景、换衣服和补妆；傍晚前往 KLCC 与双子塔，视体力决定是否去 Saloma Link，晚餐暂留在 KLCC 区域灵活安排。
...
| 项目 | 当前安排 |
| --- | --- |
| Day 1 | KUL T2 接机 → Eaton Residence KLCC 泳池休息 → KLCC / 双子塔夜景 → 餐饮待现场确认 |
...
| --- | --- | --- | --- |
| 10/15-10/16 | Eaton Residence KLCC | Eaton Residence KLCC | Jalan Kia Peng, 50450 Kuala Lumpur, Malaysia |
| 10/16-10/18 | 马六甲惠胜酒店 | Hatten Hotel Melaka | Jalan Merdeka, Banda Hilir, 75000 Melaka, Malaysia |
...
| **必经** | Eaton Residence KLCC | 吉隆坡住宿、第一晚出发点 |
...
| 分类 | 内容 |
| --- | --- |
| [每日行程 / Daily Itinerary](./itinerary/) | 时间窗口、路线细化、雨天方案、可取消节点 |
| [餐厅与美食 / Food & Restaurants](./food/) | 吉隆坡、马六甲餐厅、夜市和咖啡馆候选 |
| [交通方案 / Transport](./transport/) | 机场接送、市内交通、吉隆坡-马六甲、马六甲-KLIA |
